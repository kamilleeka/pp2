...
def main():
    ...
    # загрузка изобрежний
    clock_image = pygame.transform.scale(pygame.image.load('images/main-clock.png'), (800, 600))
    sechand_image = pygame.image.load('./images/left-hand.png')
    sechand_image = pygame.transform.scale(sechand_image, (350, 175))
    sechand_rect = sechand_image.get_rect()
    sechand_rect.center = (400, 300)
    minhand_image = pygame.image.load('./images/right-hand.png')
    minhand_image = pygame.transform.scale(minhand_image, (300, 150))
